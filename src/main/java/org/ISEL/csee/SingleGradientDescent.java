...
public class SingleGradientDescent {
    ...
    public float[] run(List<Double> x, List<Double> y, float learningRate, float initial_w, float initial_b, int epochs) {
        float w = initial_w;
        float b = initial_b;
        ...
        System.out.println("Input features(index): " + x.get(instanceIndex));
