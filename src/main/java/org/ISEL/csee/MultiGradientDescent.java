...
public class MultiGradientDescent {
    ...
    public List<Double> run(List<List<Double>> wholeX, List<Double> y, float learningRate, List<Double> initial_w, int epochs) {
        ...
        System.out.println("Input features(index): " + wholeX.get(instanceIndex));
